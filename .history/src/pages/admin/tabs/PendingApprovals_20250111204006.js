  ...
  const handleApprove = async (item) => {
    try {
      ...
      if (item.type === 'blog') {
        ...
        setPendingHospitals(pendingHospitals.filter(hospital => hospital.id !== item.id));
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      By {blog.author} • {blog.category} • Submitted on {blog.submittedAt}
                    </p>
                  </div>
                </div>
      ...
      <div>
        ...
        <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      By {hospital.submittedBy} • Submitted on {hospital.submittedAt}
                    </p>
                  </div>
                </div>
                <div className="flex gap-2">
          ...
          {pendingHospitals.length === 0 && (
            <p className="text-gray-500 text-center py-4">No pending hospitals</p>
          )}
        </div>
      </div>
    </div>
