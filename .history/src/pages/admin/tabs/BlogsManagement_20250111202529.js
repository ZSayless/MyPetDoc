    ...
    <div>
      ...
      <div className="flex flex-wrap items-center gap-4 mb-6">
        <div className="flex flex-wrap items-center gap-4 flex-1">
          <select className="min-w-[150px] px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100">
        ...
        <button className="whitespace-nowrap flex items-center justify-center gap-2 px-4 py-2 bg-[#98E9E9] text-gray-700 rounded-lg hover:bg-[#7CD5D5] transition-colors">
          <FileText size={20} />
          Create New Blog
        </button>
      </div>
