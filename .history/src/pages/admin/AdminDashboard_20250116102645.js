        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-3 md:gap-6 md:p-6">
          ...
          <div className="bg-white rounded-lg p-3 md:p-6">
            ...
            <div className="mt-1 md:mt-2 flex items-baseline">
              ...
              <span className="ml-2 text-xs md:text-sm text-green-500">+12%</span>
            </div>
            <p className="text-xs md:text-sm text-gray-400 mt-1">from last month</p>
          </div>

          {/* Total Hospitals */}
          <div className="bg-white rounded-lg p-3 md:p-6">
            <h3 className="text-gray-500 text-xs md:text-sm">Total Hospitals</h3>
            <div className="mt-1 md:mt-2 flex items-baseline">
              <p className="text-lg md:text-2xl font-bold">56</p>
              <span className="ml-2 text-xs md:text-sm text-green-500">+3</span>
            </div>
            <p className="text-xs md:text-sm text-gray-400 mt-1">new this month</p>
          </div>
          ...
          <div className="bg-white rounded-lg p-3 md:p-6">
            ...
            <div className="mt-1 md:mt-2 flex items-baseline">
              ...
              <span className="ml-2 text-xs md:text-sm text-green-500">+25%</span>
            </div>
            <p className="text-xs md:text-sm text-gray-400 mt-1">from last month</p>
          </div>
          ...
          {/* Pending Approvals */}
          <div className="bg-white rounded-lg p-3 md:p-6">
            <h3 className="text-gray-500 text-xs md:text-sm">Pending Approvals</h3>
            <div className="mt-1 md:mt-2 flex items-baseline">
              <p className="text-lg md:text-2xl font-bold">12</p>
              <span className="ml-2 text-xs md:text-sm text-yellow-500">Active</span>
            </div>
            <p className="text-xs md:text-sm text-gray-400 mt-1">requires attention</p>
          </div>
        </div>
