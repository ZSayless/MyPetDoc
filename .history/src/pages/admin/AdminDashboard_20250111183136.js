...
function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-0 bottom-0 w-[280px] bg-white shadow-lg z-30 transition-all duration-300 lg:translate-x-0 ${
        ...
        <div className="p-4">
          <h1 className="text-xl font-bold text-gray-800 hidden lg:block">Admin Dashboard</h1>
          <Link
            to="/"
      ...
      {/* Main Content */}
      <div className="lg:ml-[280px] p-4 lg:p-8 mt-[60px] lg:mt-0">
        {/* Desktop Header */}
