        ...
        <div className="bg-white rounded-2xl">
          <div className="flex items-center justify-between p-4 hover:bg-gray-50 cursor-pointer">
            <div>
              ...
              <div className="text-gray-600 mt-1">{user.socialMedia.website}</div>
            </div>
            <span className="text-gray-400 text-xl">›</span>
          </div>
          ...
          <div className="border-t">
            <div className="flex items-center justify-between p-4 hover:bg-gray-50 cursor-pointer">
              <div>
                ...
                <div className="text-gray-600 mt-1">{user.socialMedia.github}</div>
              </div>
              <span className="text-gray-400 text-xl">›</span>
            </div>
          </div>
          ...
          <div className="border-t">
            <div className="flex items-center justify-between p-4 hover:bg-gray-50 cursor-pointer">
              <div>
                ...
                <div className="text-gray-600 mt-1">{user.socialMedia.linkedin}</div>
              </div>
              <span className="text-gray-400 text-xl">›</span>
            </div>
          </div>
          ...
          <div className="border-t">
            <div className="flex items-center justify-between p-4 hover:bg-gray-50 cursor-pointer">
              <div>
                ...
                <div className="text-gray-600 mt-1">{user.socialMedia.facebook}</div>
              </div>
              <span className="text-gray-400 text-xl">›</span>
            </div>
          </div>
          ...
          <div className="border-t">
            <div className="flex items-center justify-between p-4 hover:bg-gray-50 cursor-pointer">
              <div>
                ...
                <div className="text-gray-600 mt-1">{user.socialMedia.youtube}</div>
              </div>
              <span className="text-gray-400 text-xl">›</span>
            </div>
          </div>
          ...
          <div className="border-t">
            <div className="flex items-center justify-between p-4 hover:bg-gray-50 cursor-pointer">
              <div>
                ...
                <div className="text-gray-600 mt-1">{user.socialMedia.tiktok}</div>
              </div>
              <span className="text-gray-400 text-xl">›</span>
            </div>
          </div>
