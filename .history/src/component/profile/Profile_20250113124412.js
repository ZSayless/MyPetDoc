...
import { Star, MapPin, Calendar, Mail, Phone, Github, Linkedin, Facebook, Globe } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            ...
            <div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <button className="text-blue-600 hover:text-blue-800 text-sm mt-4">
                  View All Reviews →
                </button>
              </div>
            </div>
