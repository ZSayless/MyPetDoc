...
function Profile() {
  ...
  const renderPersonalInfo = () => (
    <div>
      <h2 className="text-2xl mb-2">Thông tin cá nhân</h2>
      <p className="text-gray-600 mb-8">Quản lý thông tin cá nhân của bạn.</p>

      <div className="bg-white rounded-lg">
        <div className="p-6 border-b">
          <h3 className="text-lg font-medium mb-1">Thông tin cơ bản</h3>
        ...
        <div>
          <div className="border-b">
            ...
            >
              <div>
                <div className="font-medium mb-1">Họ và tên</div>
          ...
          <div className="border-b">
            <div className="flex items-center justify-between p-6 hover:bg-gray-50 cursor-pointer">
              <div>
                <div className="font-medium mb-1">Tên người dùng</div>
          ...
          <div>
            <div className="flex items-center justify-between p-6 hover:bg-gray-50 cursor-pointer">
              <div>
                <div className="font-medium mb-1">Ảnh đại diện</div>
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FF]">
      <div className="max-w-[1200px] mx-auto px-4 py-8">
        ...
        {/* Main Container */}
        <div className="grid grid-cols-[280px,1fr] bg-white rounded-lg overflow-hidden">
          {/* Sidebar */}
