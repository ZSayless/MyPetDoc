          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                <select 
                  className="px-3 py-2.5 text-sm md:text-base rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-100 text-gray-600 cursor-pointer hover:border-blue-200"
                >
                ...
                <select 
                  className="col-span-2 md:col-span-1 px-3 py-2.5 text-sm md:text-base rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-100 text-gray-600 cursor-pointer hover:border-blue-200"
                >
