      ...
      <div className="bg-blue-600">
        <div className="container mx-auto px-4 py-8 md:py-12">
          <div className="max-w-3xl mx-auto">
            ...
            {/* Search and Filters */}
            <div className="bg-white rounded-xl shadow-lg p-3 md:p-4 space-y-3 md:space-y-0 md:flex md:items-center md:gap-4">
              {/* Search Bar */}
              <div className="relative flex-1">
                <input
                  type="text"
                  placeholder="Search by hospital name or location..."
                  className="w-full pl-10 pr-4 py-2 md:py-2.5 text-sm md:text-base rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-100"
                  value={searchTerm}
              ...
              <div className="flex flex-wrap gap-2 md:gap-3">
                <select className="w-full sm:w-auto px-3 py-2.5 text-sm md:text-base rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-100 text-gray-600">
