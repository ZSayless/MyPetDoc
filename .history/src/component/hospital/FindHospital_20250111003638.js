      ...
      <div className="bg-blue-600">
        <div className="container mx-auto px-4 py-8 md:py-12">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-2xl md:text-3xl font-bold text-white text-center mb-2 md:mb-3">
              Find a Hospital Near Me
            </h1>
            <p className="text-sm md:text-base text-white/80 text-center mb-6 md:mb-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-4">
              ...
              <div className="relative mb-3 md:mb-4">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 text-sm md:text-base rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-100"
                  value={searchTerm}
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                <select className="px-3 py-2.5 text-sm md:text-base rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-100 text-gray-600 cursor-pointer hover:border-blue-200">
                ...
                <select className="col-span-2 md:col-span-1 px-3 py-2.5 text-sm md:text-base rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-100 text-gray-600 cursor-pointer hover:border-blue-200">
