...
const CITIES = [
  ...
  { id: "d8", name: "District 8" },
  { id: "d9", name: "District 9" },
  { id: "d10", name: "District 10" },
  { id: "d11", name: "District 11" },
  { id: "d12", name: "District 12" },
  { id: "bthanh", name: "Binh Thanh District" },
  { id: "tduc", name: "Thu Duc City" },
];
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-3 mb-6">
              ...
              <div className="relative">
                ...
                >
                  <span>
                    {CITIES.find(city => city.id === selectedCity)?.name || "Select City"}
                  </span>
