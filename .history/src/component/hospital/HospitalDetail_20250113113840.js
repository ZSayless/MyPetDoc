...
const HospitalDetail = () => {
  ...
  const [isLoggedIn, setIsLoggedIn] = useState(false); // Tạm thời để test, sau này sẽ lấy từ auth context
  ...
  const handleAddComment = (photoId, comment) => {
    ...
    // Cập nhật selectedPhoto để hiển thị comment mới ngay lập tức
