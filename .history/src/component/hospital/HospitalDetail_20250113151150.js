        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <img src={Logo} alt="myPetDoc" className="h-8 md:h-10" />
              <div>
                <h3 className="font-bold text-lg">myPetDoc</h3>
                <p className="text-xs text-gray-500">HAPPY PES, NEARBY VETS</p>
              </div>
            </div>
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="max-w-3xl">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
            Pet Care Hospital & Wellness Center
          </h1>
          ...
          <div className="grid grid-cols-3 gap-2 md:flex md:gap-4">
            <button className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 px-2 md:px-6 py-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors text-sm md:text-base">
              <Heart className="w-5 h-5" />
              <span className="text-center">Add<br className="md:hidden" />Favorite</span>
            </button>
            <button className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 px-2 md:px-8 py-3 bg-[#67009B] text-white rounded-lg hover:bg-[#53007c] transition-colors text-sm md:text-base">
              <Phone className="w-5 h-5" />
              <span className="text-center">Call<br className="md:hidden" />Now</span>
            </button>
            <button className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 px-2 md:px-8 py-3 bg-[#98E9E9] text-gray-700 rounded-lg hover:bg-[#7CD5D5] transition-colors text-sm md:text-base">
              <MapPin className="w-5 h-5" />
              <span className="text-center">Get<br className="md:hidden" />Directions</span>
            </button>
          </div>
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    onClick={() => {
                      if (!isAuthenticated || !user) {
                        setShowLoginModal(true);
                        // Lưu callback để mở modal upload sau khi đăng nhập
                        setLoginSuccessCallback(() => () => {
                          setShowUploadModal(true);
                        });
                        return;
