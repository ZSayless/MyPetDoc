...
const MOCK_HOSPITAL = {
  ...
  mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.669658423711!2d106.66488007465357!3d10.75992005944615!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f9023a3a85d%3A0x9259bad475336d5c!2zQuG7h25oIHZp4buHbiBUaMO6IHkgUGV0UHJv!5e0!3m2!1svi!2s!4v1710338305071!5m2!1svi!2s&zoom=16",
  rating: 4.9,
  workingHours: [
...
const HospitalDetail = () => {
  ...
  const handleGetDirections = () => {
    if (hospital?.mapUrl) {
      window.open(
        hospital.mapUrl.replace('/embed?', '/dir?'),
        '_blank'
      );
    }
  };
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="bg-[#4611a7] text-white px-4 py-2 rounded-lg hover:bg-[#3a0d8c] transition-colors text-sm"
              >
                Upload Photo
              </button>
            </div>
