            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="absolute -left-4 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full w-8 h-8 flex items-center justify-center shadow-md"
                >
                  <ChevronLeft className="w-5 h-5" />
                </button>

                <div
                  className="flex items-center gap-2 overflow-hidden mx-14"
                  ref={servicesRef}
                >
                ...
                <button
                  ...
                  className="absolute -right-4 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full w-8 h-8 flex items-center justify-center shadow-md"
                >
