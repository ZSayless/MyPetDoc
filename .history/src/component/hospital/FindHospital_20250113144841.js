...
const FindHospital = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Header Section với Search và Filters */}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative mt-4">
              <button
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full w-8 h-8 flex items-center justify-center shadow-md"
              >
              ...
              <button
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full w-8 h-8 flex items-center justify-center shadow-md"
              >
      ...
      <div className="flex flex-1">
        ...
        {/* Map - Fixed */}
        <div className="w-1/2 sticky top-0" style={{ height: 'calc(100vh - 200px)' }}>
          <iframe
