...
const FindHospital = () => {
  ...
  const handlePageChange = (pageNumber) => {
    ...
    // Scroll mượt hơn với window.scrollTo
    window.scrollTo({
      top: listContainerRef.current.offsetTop - 100, // Trừ đi 100px để có khoảng cách với top
      behavior: "smooth",
    });
  };
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white p-4 rounded-xl shadow-sm text-center">
            <div className="text-2xl font-bold text-blue-600 mb-1">{MOCK_HOSPITALS.length}</div>
                ...
                >
                  <div className="p-4">
                    ...
                    <div className="mt-4 flex justify-end">
                      <button
                        className="px-6 py-2 bg-[#98E9E9] hover:bg-[#7CD5D5] text-gray-700 rounded-lg transition-colors"
