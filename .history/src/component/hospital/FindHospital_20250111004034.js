          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="relative flex items-center">
                <button className="absolute left-0 z-10 p-2 rounded-full bg-white shadow-md hover:bg-gray-50">
                ...
                <button className="absolute right-0 z-10 p-2 rounded-full bg-white shadow-md hover:bg-gray-50">
