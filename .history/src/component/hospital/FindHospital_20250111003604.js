        ...
        <div className="container mx-auto px-4 py-8 md:py-12">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {/* Search Bar with Distance */}
              <div className="flex gap-2">
                <input
                  type="text"
                  placeholder="Enter address, city or zip code."
                  className="flex-1 pl-10 pr-4 py-3 text-sm md:text-base rounded-lg bg-white focus:outline-none"
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                />
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
                <select className="w-36 py-3 px-4 rounded-lg bg-white text-sm md:text-base appearance-none cursor-pointer">
