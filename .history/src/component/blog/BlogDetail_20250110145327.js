    ...
    <>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="hidden lg:block col-span-12 lg:col-span-2 relative">
            ...
            {/* Main Content */}
            <div className="col-span-12 lg:col-span-8 max-w-3xl mx-auto lg:mx-0">
              <div className="">
                {/* Blog Title */}
                <h1 className="text-[#222] text-xl sm:text-2xl lg:text-3xl font-bold leading-tight mb-6">
      ...
      {showCommentModal && (
        <>
          ...
          />
          <div
            className="fixed inset-y-0 right-0 w-full sm:w-[480px] md:w-[600px] bg-white z-[999] shadow-lg animate-[slideIn_0.3s_ease-out]"
            style={{
          ...
          >
            <div className="h-full flex flex-col">
              {/* Header */}
              <div className="flex items-center justify-between border-b p-3 sm:p-4 bg-white sticky top-0">
              ...
              {/* Comment Input */}
              <div className="p-3 sm:p-4 border-b bg-white sticky top-[57px] sm:top-[65px]">
                <div className="flex gap-3">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-[#1a1a1a] rounded-full flex items-center justify-center text-white text-sm">
                    T
                  </div>
                  <div className="flex-1">
                    <div className="bg-[#f1f1f1] rounded-lg p-2 sm:p-3 hover:bg-[#e8e8e8]">
                      <input
                        type="text"
              ...
              <div className="flex-1 overflow-y-auto bg-[#f7f8fa]">
                {mockComments.map((comment) => (
                  <div key={comment.id} className="p-3 sm:p-4 border-b bg-white">
                    <div className="flex gap-3">
                      <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-600 rounded-full flex items-center justify-center text-white text-sm">
                        {comment.user.avatar}
                      </div>
                      <div className="flex-1">
