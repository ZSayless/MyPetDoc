...
// Giả lập kiểm tra đăng nhập (thay thế bằng logic thực tế của bạn)
...
const BlogDetail = () => {
  ...
  const handleLoginSuccess = () => {
    ...
    // Nếu đang ở trạng thái muốn comment thì mở modal comment
    setShowCommentModal(true);
  };
                  ...
                  <div key={comment.id} className="p-4 border-b bg-white">
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {showReplyInput === comment.id && isAuthenticated() && (
