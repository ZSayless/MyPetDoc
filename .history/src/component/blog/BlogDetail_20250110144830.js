        ...
        <>
          ...
          >
            <div className="h-full flex flex-col">
              {/* Header */}
              <div 
                className="flex items-center justify-between border-b p-4 bg-white sticky top-0"
              >
                <div className="text-lg font-medium">{mockComments.length} bình luận</div>
                <button
                  onClick={handleCloseModal}
              ...
              {/* Comment Input */}
              <div 
                className="p-4 border-b bg-white sticky top-[65px]"
              >
                <div className="flex gap-3">
                  <div 
                    className="w-8 h-8 bg-[#1a1a1a] rounded-full flex items-center justify-center text-white text-sm"
                  >
                    T
                  </div>
                  <div className="flex-1">
                    <div 
                      className="bg-[#f1f1f1] rounded-lg p-3 hover:bg-[#e8e8e8] transition-colors"
                    >
                      <input
                        type="text"
              ...
              {/* No Comments Message */}
              <div 
                className="flex-1 flex flex-col items-center justify-center px-4 py-12 bg-[#f7f8fa]"
              >
                <div className="mb-4">
                  <img 
                    src="https://fullstack.edu.vn/static/media/none-content.b869c6ef.svg" 
