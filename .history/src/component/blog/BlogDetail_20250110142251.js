...
const BlogDetail = () => {
  ...
  const heartIconStyle = {
    filter: isLiked ? 'invert(27%) sepia(91%) saturate(2352%) hue-rotate(331deg) brightness(94%) contrast(96%)' : 'none'
  };
          ...
          <div className="col-span-12 lg:col-span-2 relative">
            <div className="sticky top-[50px] left-0 right-0 w-full">
              ...
              <div className="flex gap-[20px] mt-[20px]">
                <div
                  className={`flex gap-[4px] items-center ${isLiked ? 'text-red-500' : 'text-[#757575]'} cursor-pointer hover:text-red-500 transition-colors`}
                  onClick={handleLike}
                >
