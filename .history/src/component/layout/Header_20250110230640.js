              ...
              <nav className="hidden lg:block">
                <ul className="flex items-center space-x-6">
                  ...
                  <li className="relative" ref={servicesDropdownRef}>
                    <button
                      className="flex items-center text-gray-700 hover:text-blue-600 text-[15px]"
              ...
              {!isLoggedIn ? (
                <>
                  <button
                    ...
                    className="text-gray-700 hover:text-blue-600 font-medium text-[15px]"
                  >
                    Login
                  </button>
                  <button
                    onClick={handleOpenRegister}
                    className="bg-[#98E9E9] text-gray-700 px-4 py-1.5 rounded-lg hover:bg-[#7CD5D5] text-[15px]"
                  >
                    Register
                  </button>
                </>
