            ...
            <div className="flex items-center">
              ...
              <nav className="hidden lg:block ml-12">
                <ul className="flex items-center space-x-8">
                  ...
                  >
                    <button
                      className="flex items-center text-white hover:text-[#98E9E9] transition-colors pb-2"
                    ...
                    {showServices && (
                      <div 
                        className="absolute top-full left-0 bg-white rounded-lg shadow-lg py-2 min-w-[200px] before:content-[''] before:absolute before:top-[-10px] before:left-0 before:right-0 before:h-[10px] before:bg-transparent"
                      >
                        <Link 
                          to="/service" 
