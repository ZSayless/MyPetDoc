              ...
              <nav className="hidden lg:block">
                <ul className="flex items-center space-x-4">
                  <li>
                    <Link 
                      to="/" 
                      className="text-gray-700 hover:text-blue-600 text-[13px]"
                    >
                      Home
                    </Link>
                  </li>
                  ...
                  <li className="relative" ref={servicesDropdownRef}>
                    <button
                      className="flex items-center text-gray-700 hover:text-blue-600 text-[13px]"
                    ...
                    {showServices && (
                      <div
                        ...
                        className="absolute top-full left-0 w-[230px] bg-white rounded-lg shadow-lg py-1.5 z-50"
                      >
                        {servicesDropdown.map((service, index) => (
                          <Link
                            key={index}
                            to={service.link}
                            className="flex flex-col px-3 py-1.5 hover:bg-gray-50"
              ...
              {!isLoggedIn ? (
                <>
                  <button
                    ...
                    className="text-gray-700 hover:text-blue-600 font-medium text-[13px]"
                  >
                    Login
                  </button>
                  <button
                    onClick={handleOpenRegister}
                    className="bg-[#98E9E9] text-gray-700 px-3 py-1.5 rounded-lg hover:bg-[#7CD5D5] text-[13px]"
                  >
                    Register
                  </button>
                </>
