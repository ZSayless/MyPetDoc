...
<header className="bg-white w-full fixed top-0 left-0 right-0 z-50 shadow-sm">
  <div className="container mx-auto px-4">
    <div className="flex items-center justify-between py-3"> {/* Giảm padding */}
      <div className="flex items-center space-x-6">
        <img src={logo} alt="Logo" className="h-10" /> {/* Giảm chiều cao logo */}

        <nav className="hidden lg:block">
          <ul className="flex items-center space-x-4"> {/* Giảm khoảng cách giữa các item */}
            <li>
