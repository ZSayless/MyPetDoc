            ...
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden lg:block">
                <ul className="flex items-center space-x-5">
                  <li>
                    <Link to="/" className="text-gray-700 hover:text-blue-600 text-[14px]">
                      Home
                    </Link>
                  </li>
                  <li>
                    <Link to="/aboutus" className="text-gray-700 hover:text-blue-600 text-[14px]">
                      About Us
                    </Link>
                  </li>
                  <li>
                    <Link to="/contactus" className="text-gray-700 hover:text-blue-600 text-[14px]">
                      Contact Us
                    </Link>
                  </li>
                  <li className="relative" ref={servicesDropdownRef}>
                    <button
                      className="flex items-center text-gray-700 hover:text-blue-600 text-[14px]"
              ...
              {!isLoggedIn ? (
                <>
                  <button
                    ...
                    className="text-gray-700 hover:text-blue-600 font-medium text-[14px]"
                  >
                    Login
                  </button>
                  <button
                    onClick={handleOpenRegister}
                    className="bg-[#98E9E9] text-gray-700 px-3.5 py-1.5 rounded-lg hover:bg-[#7CD5D5] text-[14px]"
                  >
                    Register
                  </button>
                </>
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg overflow-hidden">
                      ...
                      <button
                        ...
                        className="block w-full text-left px-4 py-2.5 text-gray-700 hover:bg-gray-50"
                      >
                        Settings
                      </button>
                      <button
