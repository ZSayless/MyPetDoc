import { Mail, MapPin, Phone, Printer, User, FileText, MessageSquare } from "lucide-react";
    ...
    <section>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <h1 className="text-4xl font-bold mb-3 text-gray-900">Get In Touch</h1>
            ...
            <form className="space-y-6 contact__form">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-12 pr-6 py-3 rounded-[30px] border border-gray-300 focus:outline-none focus:border-[#4611a7] text-gray-800 text-base placeholder:text-gray-500"
                    required
                  />
              ...
              <div className="relative">
                <textarea
                  ...
                  rows="4"
                  className="w-full pl-12 pr-6 py-4 rounded-[30px] border border-gray-300 focus:outline-none focus:border-[#4611a7] text-gray-800 text-base placeholder:text-gray-500"
                  required
                ></textarea>
              ...
              <button
                type="submit"
                className="bg-[#4611a7] hover:bg-[#3a0d89] px-8 py-3 rounded-[30px] font-semibold text-white text-lg transition-colors"
              >
                SUBMIT NOW
              </button>
            </form>
