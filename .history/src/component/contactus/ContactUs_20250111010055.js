            ...
            <form className="space-y-6 contact__form">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <input
                  ...
                  className="w-full px-6 py-3 rounded-[30px] border border-gray-300 focus:outline-none focus:border-[#4611a7] text-gray-800 text-base placeholder:text-gray-500"
                  required
                />
                <input
                  type="email"
              ...
              <textarea
                ...
                rows="4"
                className="w-full px-6 py-4 rounded-[30px] border border-gray-300 focus:outline-none focus:border-[#4611a7] text-gray-800 text-base placeholder:text-gray-500"
                required
              ></textarea>
