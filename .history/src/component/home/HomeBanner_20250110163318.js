            ...
            <div className="relative h-full flex items-center px-4 md:px-8 lg:px-16">
              <div className="w-full max-w-xl md:max-w-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 ml-0 md:ml-8">
                  <button 
                    className="px-5 py-2 bg-white text-gray-900 text-sm font-medium rounded w-[120px] sm:w-[140px] hover:bg-gray-100 transition-colors"
                  >
                    Search
                  </button>
                  <button 
                    className="px-5 py-2 border border-white text-white text-sm font-medium rounded w-[120px] sm:w-[140px] hover:bg-white/10 transition-colors"
                  >
                    Learn More
                  </button>
                </div>
