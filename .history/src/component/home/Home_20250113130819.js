      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            ...
            <div className="flex gap-4">
              <button className="swiper-button-prev p-2 rounded-full border hover:bg-gray-50">
                <ArrowLeft size={20} />
              </button>
              <button className="swiper-button-next p-2 rounded-full border hover:bg-gray-50">
                <ArrowRight size={20} />
              </button>
            </div>
          </div>
          ...
          <Slider {...settings}>
            {recommendedHospitals.map(hospital => (
              <div key={hospital.id} className="bg-white rounded-lg overflow-hidden border group">
