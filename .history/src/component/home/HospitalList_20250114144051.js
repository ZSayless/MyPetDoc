      ...
      <div className="container mx-auto px-4">
        ...
        <div ref={searchRef} className="max-w-2xl mx-auto mb-8 md:mb-12 px-4">
          <div className="relative flex gap-2">
            ...
            <button 
              onClick={() => {
                // Có thể thêm logic search nếu cần
                setCurrentPage(1); // Reset về trang 1 khi search
              }}
              className="px-6 py-2 md:py-3 bg-[#1A3C8E] text-white text-sm md:text-base rounded-full hover:bg-[#98E9E9] hover:text-[#1A3C8E] transition-colors"
            >
              Search
            </button>
          </div>
