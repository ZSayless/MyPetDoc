...
const HomeCity = () => {
  ...
  return (
    <section className="py-12 md:py-16 bg-gradient-to-t from-[#98E9E9]/10 to-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-[#1A3C8E] text-2xl md:text-3xl font-bold mb-4">Top Locations</h2>
