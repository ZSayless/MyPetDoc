...
function Home() {
  ...
  const settings = {
    ...
    slidesToShow: 4,
    slidesToScroll: 1,
    nextArrow: <button className="slick-next"><ArrowRight size={20} /></button>,
    prevArrow: <button className="slick-prev"><ArrowLeft size={20} /></button>,
    responsive: [
      {
        breakpoint: 1024,
        settings: {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              <div className="space-y-4">
                {regions.map(region => (
                  <div key={region.name} className="border-b pb-4 last:border-0">
                    <a 
                      href={`/find-hospital?region=${region.name}`}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12">Recommended Hospitals</h2>

          <div className="hospital-slider">
            <Slider {...settings}>
              {recommendedHospitals.map(hospital => (
                <div key={hospital.id} className="px-2">
