            ...
            <div className="relative h-full flex items-center px-4 md:px-8 lg:px-16">
              <div className="w-full max-w-xl md:max-w-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 ml-0 md:ml-8">
                  <button className="px-6 md:px-8 py-2 md:py-3 bg-white text-gray-900 text-sm md:text-base font-medium rounded w-full sm:w-auto">
                    Search
                  </button>
                  <button className="px-6 md:px-8 py-2 md:py-3 border-2 border-white text-white text-sm md:text-base font-medium rounded w-full sm:w-auto">
                    Learn More
                  </button>
                </div>
              </div>
