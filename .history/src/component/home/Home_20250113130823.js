      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            ...
            <div className="flex gap-4">
              <button className="custom-prev-button p-2 rounded-full border hover:bg-gray-50">
                <ArrowLeft size={20} />
              </button>
              <button className="custom-next-button p-2 rounded-full border hover:bg-gray-50">
                <ArrowRight size={20} />
              </button>
            </div>
          </div>
          ...
          >
            {recommendedHospitals.map(hospital => (
              <SwiperSlide key={hospital.id}>
                <div className="bg-white rounded-lg overflow-hidden border group px-2">
