...
function HomePlace() {
  ...
  const topHospitals = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1606425271394-c3ca9aa1fc06?ixlib=rb-4.0.3",
    },
    {
      id: 5,
      name: "VetCare Clinic",
      ...
      image: "https://images.unsplash.com/photo-1576201836106-db1758fd1c97?ixlib=rb-4.0.3",
    },
    {
      id: 6,
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1612531822963-5574e6d310e5?ixlib=rb-4.0.3",
    },
    {
      id: 8,
      ...
      image: "https://images.unsplash.com/photo-1599443015574-be5fe8a05783?ixlib=rb-4.0.3",
    }
  ];
    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          <button 
            onClick={() => scroll('left')}
            className={`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-8 h-8 bg-white rounded-full shadow-md flex items-center justify-center hover:bg-gray-50 transition-opacity ${
          ...
          <div 
            ref={sliderRef}
            className="flex gap-6 overflow-x-auto scrollbar-hide scroll-smooth px-4 mx-auto justify-center"
