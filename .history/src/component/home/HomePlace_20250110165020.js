...
const HomePlace = () => {
  ...
  const NextArrow = (props) => {
    ...
    return (
      <button
        onClick={onClick}
        className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 bg-[#4611a7] text-white w-10 h-10 flex items-center justify-center rounded-l-md hover:bg-[#3a0d8c] transition-colors"
      >
        <svg
          className="w-6 h-6"
          fill="none"
  ...
  const PrevArrow = (props) => {
    ...
    return (
      <button
        onClick={onClick}
        className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-[#4611a7] text-white w-10 h-10 flex items-center justify-center rounded-r-md hover:bg-[#3a0d8c] transition-colors"
      >
        <svg
          className="w-6 h-6"
          fill="none"
  ...
  return (
    <section>
      <div className="pt-8 pb-16 md:pt-12 md:pb-20 lg:pt-16 lg:pb-24 bg-[#f5f2ff]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-[#0c0e1a]">
              Top Trending Places
            </h2>
            <div className="inline-block w-[50px] h-[3px] mb-[10px] bg-[#4611a7]"></div>
            <p className="text-[#606269] max-w-2xl mx-auto text-sm md:text-base px-4">
                ...
                <div key={place.id} className="px-3">
                  <div className="bg-white overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="p-3 md:p-4">
                      ...
                      <h3 className="text-lg md:text-xl font-bold mb-2 text-[#0c0e1a]">
                        {place.name}
                      </h3>
                      <p className="text-sm md:text-base text-[#606269] mb-4">
                        {place.description}
                      </p>
