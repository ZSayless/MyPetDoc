  ...
  const testimonials = [
    {
      ...
      role: "Pet Owner",
      content:
        "MyPetDoc made finding the right vet for my cat so easy. Excellent service!",
    ...
    },
    {
      ...
      role: "Veterinarian",
      content:
        "The platform helps us connect with pet owners efficiently. Great technology!",
      ...
      <div className="bg-gradient-to-b from-[#98E9E9] to-white">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl font-bold mb-6 text-[#1A3C8E]">About MyPetDoc</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-gray-600">
              <p>
                Founded in 2024, MyPetDoc emerged from a vision to revolutionize
                pet healthcare in Vietnam. We recognized the challenges pet
                owners face in finding reliable veterinary care and set out to
                create a solution.
              </p>
              <p>
                Our platform connects pet owners with verified veterinary
                hospitals, making quality pet care accessible to all. We're
                committed to supporting both pet owners and veterinary
                professionals in providing the best possible care for our furry
                friends.
              </p>
              <p>
                Today, we're proud to partner with leading veterinary hospitals
                across Vietnam, serving thousands of pet owners and their
                beloved companions.
              </p>
            </div>
          </div>
