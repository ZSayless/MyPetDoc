...
export const communityService = {
  ...
  getPosts: async () => {
    try {
      ...
      // Lưu vào localStorage để đảm bảo cấu trúc đúng
    ...
    try {
      ...
      const newComment = {
        ...
        author: {
          ...
          avatar: commentData.author.avatar || "https://via.placeholder.com/150",
        },
  ...
  deleteComment: async (postId, commentId) => {
    try {
      ...
      try {
        // Tìm comment cần xóa để kiểm tra
        const commentToDelete = posts[postIndex].comments.find(
          (c) => c && c.id === commentId
        );
