...
export const communityService = {
  ...
  getPostById: (postId) => axios.get(`${BASE_URL}/posts/${postId}`),

  createPost: (data) => axios.post(`${BASE_URL}/posts`, data),

  updatePost: (postId, data) => axios.put(`${BASE_URL}/posts/${postId}`, data),
  ...
  // Likes
  likePost: (postId) => axios.post(`${BASE_URL}/posts/${postId}/like`),

  unlikePost: (postId) => axios.delete(`${BASE_URL}/posts/${postId}/like`),
