            ...
            <div className="border-b mt-6">
              <div className="flex gap-6">
                ...
                <button
                  ...
                  className={`pb-4 relative ${
                    filter === "published" ? "text-blue-600" : "text-gray-600 hover:text-gray-900"
                  }`}
                >
                ...
                <button
                  ...
                  className={`pb-4 relative ${
                    filter === "draft" ? "text-blue-600" : "text-gray-600 hover:text-gray-900"
                  }`}
                >
                          ...
                          {blog.status === "draft" ? (
                            <>
                              ...
                              >
                                ...
                                <span className="text-sm">{t('myBlogs.actions.edit')}</span>
                              </Link>
                              <button className="flex items-center gap-1 text-red-600 hover:text-red-700">
                                <Trash2 className="w-4 h-4" />
                                <span className="text-sm">{t('myBlogs.actions.delete')}</span>
                              </button>
                            </>
                          ) : (
                            <Link
                              ...
                              className="flex items-center gap-1 text-blue-600 hover:text-blue-700"
                            >
                              <span className="text-sm">{t('myBlogs.actions.view')}</span>
                            </Link>
                          )}
                        </div>
                      </div>
