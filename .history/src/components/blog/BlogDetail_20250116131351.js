    ...
    <section className="py-12">
      ...
      {showComments && (
        <>
          ...
          <div className="fixed inset-y-0 right-0 w-[480px] bg-white shadow-lg flex flex-col z-[9999]">
            {/* Header */}
            ...
            {/* Comments List - thêm min-height và max-height */}
            ...
            {/* Comment Form */}
            <div className="sticky bottom-0 border-t px-6 py-4 bg-white">
              <form onSubmit={handleSubmitComment}>
                <textarea
                  value={newComment}
                  onChange={(e) => setNewComment(e.target.value)}
                  placeholder="Write a comment..."
                  className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-100 focus:border-blue-400 resize-none"
                  rows="3"
                />
                <button
                  type="submit"
                  className="w-full mt-3 py-3 bg-[#1A73E8] text-white rounded-lg hover:bg-blue-600 font-medium text-center"
                >
                  Post Comment
                </button>
              </form>
