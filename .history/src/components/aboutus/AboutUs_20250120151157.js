      ...
      <div className="bg-gradient-to-b from-[#98E9E9] to-white">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700">{t("aboutUs.subtitle")}</p>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {t("aboutUs.team.members", { returnObjects: true }).map(
              (member, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <div className="flex justify-center items-center gap-4 mt-4">
                    <a
                      href="#"
                      className="text-gray-400 hover:text-[#1A3C8E] transition-colors"
                      target="_blank"
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {t("aboutUs.testimonials.list", { returnObjects: true }).map(
              (testimonial, index) => (
