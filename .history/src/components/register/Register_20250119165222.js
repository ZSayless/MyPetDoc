          ...
          {isGoogleSignup ? (
              ...
              <div className="flex space-x-4 p-1 bg-gray-100 rounded-[20px]">
                <button
                  className={`flex-1 py-2 px-4 rounded-2xl ${
                    userType === "general" ? "bg-white shadow" : ""
                  }`}
                  onClick={() => setUserType("general")}
                >
                  {t("auth.selectRole.petOwner")}
                </button>
                <button
                  className={`flex-1 py-2 px-4 rounded-2xl ${
                    userType === "hospital" ? "bg-white shadow" : ""
                  }`}
                  onClick={() => setUserType("hospital")}
                >
                  {t("auth.selectRole.veterinarian")}
                </button>
              </div>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? t("auth.signingIn") : t("auth.continueButton")}
              </button>
