          ...
          <form className="space-y-3">
            ...
            <div className="flex items-center mb-4">
              ...
              <span className="text-sm text-gray-600">
                {t("auth.agreeTerms")} <Link to="/terms" className="text-blue-600 hover:underline">{t("auth.termsOfService")}</Link>
              </span>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#98E9E9] text-gray-700 py-3 rounded-lg font-medium hover:bg-[#7CD5D5]"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 border border-gray-300 py-3 rounded-lg hover:bg-gray-50"
            >
