    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">{t("home.cities.title")}</h2>
          <p className="text-gray-600">{t("home.cities.subtitle")}</p>
        </div>
        ...
        <div className="text-center mt-8">
          <Link to="/cities" className="text-blue-600 hover:text-blue-700">
