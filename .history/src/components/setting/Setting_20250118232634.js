...
function Setting() {
  ...
  const renderPersonalInfo = () => (
    <div>
      ...
      <div className="bg-[#F8F9FF] rounded-2xl">
        <div className="p-4">
          <h3 className="text-base font-medium mb-1">{t('setting.personal.basic.title')}</h3>
        ...
        <div className="bg-white rounded-2xl">
          ...
          >
            <div>
              <div className="font-medium">{t('setting.personal.basic.fullName')}</div>
          ...
          <div className="border-t">
            ...
            >
              <div>
                <div className="font-medium">{t('setting.personal.basic.username')}</div>
          ...
          <div className="border-t">
            ...
            >
              <div>
                <div className="font-medium">{t('setting.personal.basic.avatar')}</div>
      ...
      <div className="bg-[#F8F9FF] rounded-2xl mt-8">
        <div className="p-4">
          <h3 className="text-base font-medium mb-1">{t('setting.personal.social.title')}</h3>
          <p className="text-gray-600 text-sm">
      ...
      <div className="bg-[#F8F9FF] rounded-2xl mt-8">
        <div className="p-4">
          <h3 className="text-base font-medium mb-1">Language / Ngôn ngữ</h3>
  ...
  const renderSecurityInfo = () => (
    <div>
      ...
      <div className="bg-[#F8F9FF] rounded-2xl">
        <div className="p-4">
          <h3 className="text-base font-medium mb-1">{t('setting.security.login.title')}</h3>
          <p className="text-gray-600 text-sm">{t('setting.security.login.description')}</p>
        </div>
        ...
        <div className="bg-white rounded-2xl">
          ...
          >
            <div>
              <div className="font-medium">{t('setting.security.login.changePassword')}</div>
              <div className="text-gray-600 mt-1">{t('setting.security.login.notChanged')}</div>
            </div>
            <span className="text-gray-400 text-xl">›</span>
          </div>
        </div>
            ...
            <div className="col-span-12 lg:col-span-3">
              ...
              <div className="hidden lg:block sticky top-20">
                ...
                >
                  ...
                  <span className="font-medium">{t('setting.personal.tab')}</span>
                </button>
                <button
                ...
                >
                  <span className="text-xl">🔒</span>
                  <span className="font-medium">{t('setting.security.tab')}</span>
                </button>
              </div>
            </div>
