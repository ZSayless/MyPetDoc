  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl w-full max-w-md">
        <div className="p-6">
          <h3 className="text-2xl font-semibold mb-2">{t('setting.modal.changePassword.title')}</h3>
          <p className="text-gray-600 mb-6">
            {t('setting.modal.changePassword.description', 'Your password must be at least 8 characters long and include numbers, letters, and special characters (!$@%...).')}
          </p>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input
                ...
                placeholder={t('setting.modal.changePassword.currentPasswordPlaceholder')}
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                name="newPassword"
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"
                placeholder={t('setting.modal.changePassword.newPasswordPlaceholder')}
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"
                placeholder={t('setting.modal.changePassword.confirmPasswordPlaceholder')}
              />
            </div>
