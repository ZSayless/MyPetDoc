...
function Setting() {
  ...
  const handleEditSocial = (platform) => {
    setSelectedSocial({
      platform,
      value: profileData.social[platform.toLowerCase()],
    });
  };
  ...
  const renderPersonalInfo = () => (
    <div>
        ...
        <div className="bg-white rounded-2xl">
          ...
          >
            <div>
              ...
              <div className="text-gray-600 mt-1">{profileData.name}</div>
            </div>
          ...
          <div className="border-t">
            ...
            >
              <div>
                ...
                <div className="text-gray-600 mt-1">{profileData.username}</div>
              </div>
              <span className="text-gray-400 text-xl">›</span>
            </div>
          </div>
      ...
      <div className="bg-[#F8F9FF] rounded-2xl mt-8">
        ...
        <div className="bg-white rounded-2xl">
          {Object.entries(profileData.social).map(([platform, link]) => (
            <div
              key={platform}
