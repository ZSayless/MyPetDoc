        ...
        <div className="bg-white rounded-2xl">
          ...
          >
            <div>
              ...
              <div className="text-gray-600 mt-1">{user?.name || "Admin User"}</div>
            </div>
          ...
          <div className="border-t">
            ...
            >
              <div>
                ...
                <div className="text-gray-600 mt-1">{user?.username || user?.email?.split('@')[0]}</div>
              </div>
              <span className="text-gray-400 text-xl">›</span>
            </div>
          </div>
              ...
              >
                <div>
                  ...
                  <div className="text-gray-600 mt-1">
                    {(user?.socialMedia && user.socialMedia[platform.toLowerCase()]) || t("setting.personal.social.notLinked")}
                  </div>
                </div>
                <span className="text-gray-400 text-xl">›</span>
              </div>
