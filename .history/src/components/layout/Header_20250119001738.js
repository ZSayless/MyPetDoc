              ...
              <div className="flex flex-col h-full">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-6">
                        ...
                        >
                          ...
                          <span className="text-lg">{t("nav.findHospital")}</span>
                        </Link>
                        <Link
                          to="/bloglist"
                          className="flex items-center space-x-3 text-gray-700"
                ...
                <div className="p-6 space-y-3">
                  <button
                    ...
                    className="w-full py-3 text-center border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50"
                  >
                    Login
                  </button>
                  <button
                    ...
                    className="w-full py-3 text-center bg-[#27378C] text-white rounded-lg hover:bg-[#1e2b6e]"
                  >
                    Register
                  </button>
                </div>
