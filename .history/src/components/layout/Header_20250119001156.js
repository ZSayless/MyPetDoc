                  ...
                  <div className="p-6 border-t border-gray-200 bg-gray-50">
                    <div className="grid grid-cols-2 gap-4">
                      <button
                        ...
                        className="w-full py-2.5 px-4 text-gray-700 font-medium border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors"
                      >
                        {t("auth.loginButton")}
                      </button>
                      <button
                        ...
                        className="w-full py-2.5 px-4 bg-[#98E9E9] text-gray-700 font-medium rounded-lg hover:bg-[#7CD5D5] transition-colors"
                      >
                        {t("auth.register")}
                      </button>
                    </div>
