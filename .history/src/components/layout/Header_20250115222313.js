        ...
        {isMenuOpen && (
          <>
            <div
              ...
              onClick={toggleMenu}
            />
            <div className="fixed inset-y-0 right-0 w-[280px] bg-gradient-to-b from-[#98E9E9] to-white/95 backdrop-blur-sm z-50 transform transition-transform duration-300 ease-in-out">
              <button
                onClick={toggleMenu}
                className="absolute top-4 right-4 text-gray-600 p-2 hover:bg-white/50 rounded-full"
              >
                <X size={24} />
              </button>
              ...
              <div className="p-6">
                <nav className="space-y-6">
                  ...
                  <div>
                    <div className="text-gray-600 uppercase text-sm font-medium px-3 mb-2">
                      Services
                    </div>
                    <div className="space-y-2">
                      <Link
