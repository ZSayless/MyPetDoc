              ...
              <nav className="hidden lg:block">
                <ul className="flex items-center space-x-4">
                  ...
                  <li className="relative" ref={servicesDropdownRef}>
                    <button onClick={handleServicesClick} className="flex items-center text-gray-700 hover:text-blue-600">
                      {t('nav.services.title')}
                      <ChevronDown className="w-4 h-4 ml-1" />
                    </button>
                    {showServices && (
                      <div className="absolute left-0 mt-2 w-60 bg-white rounded-lg shadow-lg border py-1">
                        <Link to="/find-hospital" className="block px-4 py-2 text-gray-700 hover:bg-gray-50" onClick={() => setShowServices(false)}>
                          <div className="font-medium">{t('nav.findHospital')}</div>
                          <div className="text-sm text-gray-600">
                            {t('nav.services.findHospitalDesc')}
                          </div>
                        </Link>
                        <Link to="/bloglist" className="block px-4 py-2 text-gray-700 hover:bg-gray-50" onClick={() => setShowServices(false)}>
                          <div className="font-medium">{t('nav.blog')}</div>
                          <div className="text-sm text-gray-600">
                            {t('nav.services.blogDesc')}
                          </div>
                        </Link>
                        <Link to="/community" className="block px-4 py-2 text-gray-700 hover:bg-gray-50" onClick={() => setShowServices(false)}>
                          <div className="font-medium">{t('nav.community')}</div>
                          <div className="text-sm text-gray-600">
                            {t('nav.services.communityDesc')}
                          </div>
                        </Link>
                        <Link to="/terms" className="block px-4 py-2 text-gray-700 hover:bg-gray-50" onClick={() => setShowServices(false)}>
                          <div className="font-medium">{t('nav.services.termsTitle')}</div>
                          <div className="text-sm text-gray-600">
              ...
              <div className="hidden md:flex items-center gap-6">
                <div className="relative" ref={dropdownRef}>
                  <button
                    ...
                    className="flex items-center gap-2 text-gray-700 hover:text-[#1A3C8E]"
                  >
                  ...
                  <div ref={dropdownRef} className="relative">
                    ...
                    {showUserMenu && (
                      <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2">
                        ...
                        <Link to="/my-blogs" className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
                          {t('auth.myBlogs')}
                        </Link>
                        {isAdmin && (
                        ...
                        <Link to="/setting" className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
                          {t('auth.settings')}
                        </Link>
                        <button
                          onClick={() => {
