                ...
                {!currentUser ? (
                  <>
                    <ButtonLink
                      ...
                      className="text-gray-700 hover:text-[#1A3C8E]"
                    >
                      Login
                    </ButtonLink>
                    <ButtonLink
                      onClick={() => setIsOpenRegister(true)}
                      className="bg-[#98E9E9] text-gray-700 px-6 py-2 rounded-lg hover:bg-[#7CD5D5]"
                    >
                      Register
                    </ButtonLink>
                  </>
                  ...
                  <div ref={dropdownRef} className="relative">
                    ...
                    >
                      <div className="w-10 h-10 bg-[#98E9E9] rounded-full flex items-center justify-center text-gray-700 font-medium">
                        {currentUser.avatar}
                      </div>
                    </button>
