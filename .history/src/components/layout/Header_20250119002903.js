                ...
                <HeadlessMenu as="div" className="relative inline-block text-left">
                  {({ open }) => (
                    <>
                      ...
                      >
                        <span className="text-lg">{languages.find(lang => lang.code === i18n.language)?.flag}</span>
                        <span className="text-sm">{languages.find(lang => lang.code === i18n.language)?.shortCode}</span>
                      </HeadlessMenu.Button>
