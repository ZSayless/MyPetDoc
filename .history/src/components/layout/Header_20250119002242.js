            ...
            <div className="hidden lg:flex items-center space-x-6">
              <div className="hidden md:flex items-center gap-6">
                <HeadlessMenu as="div" className="relative inline-block text-left">
                  {({ open }) => (
                    <>
                      <HeadlessMenu.Button className="flex items-center space-x-2 px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                      ...
                      >
                        <HeadlessMenu.Items
                          static
                          className="absolute right-0 mt-2 w-56 origin-top-right bg-white divide-y divide-gray-100 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                        >
                              ...
                              <HeadlessMenu.Item key={language.code}>
                                {({ active }) => (
                                  <button
                                    ...
                                    className={`${
                                      active ? 'bg-[#27378C] text-white' : 'text-gray-900'
                                    } ${
