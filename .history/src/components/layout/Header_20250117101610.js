                  ...
                  <li className="relative" ref={servicesDropdownRef}>
                    ...
                    {showServices && (
                      <div className="absolute left-0 mt-2 w-60 bg-white rounded-lg shadow-lg border py-1">
                        <Link to="/find-hospital" className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
                          <div className="font-medium">{t('nav.findHospital')}</div>
                          <div className="text-sm text-gray-600">
                            Search for nearby veterinary hospitals
                          </div>
                        </Link>
                        <Link to="/bloglist" className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
                          <div className="font-medium">Blog</div>
                          <div className="text-sm text-gray-600">
                            Read latest news and articles
                          </div>
                        </Link>
                        <Link to="/community" className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
                          <div className="font-medium">Community</div>
                          <div className="text-sm text-gray-600">
                            Join our pet lovers community
                          </div>
                        </Link>
                        <Link to="/terms" className="block px-4 py-2 text-gray-700 hover:bg-gray-50">
