                  ...
                  {!user ? (
                    <div className="p-4 space-y-3">
                      <button
                        ...
                        className="w-full py-2.5 text-center text-gray-700 hover:text-blue-600"
                      >
                        {t("auth.loginButton")}
                      </button>
                      <button
                        ...
                        className="w-full py-2.5 text-center bg-[#27378C] text-white rounded-lg hover:bg-[#1e2b6e]"
                      >
                        {t("auth.register")}
                      </button>
                    </div>
