              ...
              <div className="hidden md:flex items-center gap-6">
                <HeadlessMenu as="div" className="relative inline-block text-left">
                  {({ open }) => (
                    <>
                      <HeadlessMenu.Button 
                        className="flex items-center space-x-2 px-4 py-2 bg-gray-50 hover:bg-gray-100 rounded-full transition-colors"
                      >
                      ...
                      >
                        <HeadlessMenu.Items
                          static
                          className="absolute right-0 mt-2 w-40 origin-top-right bg-white rounded-xl shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden"
                        >
                              ...
                              {({ active }) => (
                                ...
                                >
                                  <div className="flex items-center gap-3">
                                    <span className="text-gray-600">{language.shortName}</span>
