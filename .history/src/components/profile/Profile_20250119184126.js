...
import EditNameModal from "../setting/modals/EditNameModal";
import EditAvatarModal from "../setting/modals/EditAvatarModal";
import EditSocialMediaModal from "../setting/modals/EditSocialMediaModal";
import ChangePasswordModal from "../setting/modals/ChangePasswordModal";
...
function Profile() {
  ...
  const joinedDate = useMemo(() => {
    ...
    return "March 2024"; // Fallback date
  }, [user?.createdAt]);
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            <div 
              ...
              className="w-32 h-32 bg-green-600 rounded-full flex items-center justify-center text-white text-4xl border-4 border-white shadow-lg cursor-pointer hover:opacity-90"
            >
              {user?.avatar || user?.firstName?.[0] || user?.email?.[0]?.toUpperCase() || "U"}
            </div>
            ...
            <div onClick={() => setShowEditSocial(true)} className="cursor-pointer">
              <SocialMediaLinks />
            </div>
