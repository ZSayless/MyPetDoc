...
function CommunityList() {
  ...
  const handleEdit = (post) => {
    // Chỉ author mới được edit bài của mình, admin không được edit bài của người khác
    if (!isAuthor(post)) {
  ...
  // Helper function để kiểm tra author
  ...
  const handleDelete = (postId) => {
    if (window.confirm(t("community.post.deleteConfirm"))) {
      try {
        ...
        // Admin có thể xóa mọi bài, user thường chỉ xóa được bài của mình
              ...
              >
                ...
                <div className="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-between p-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {/* Hiển thị menu nếu là admin hoặc author */}
                      ...
                      <div className="relative">
                        ...
                        {selectedPost?.id === post.id && (
                          <div className="absolute right-0 mt-1 w-32 bg-white rounded-lg shadow-lg py-1 z-10">
                            {/* Chỉ hiển thị nút Edit cho author, không cho admin edit bài người khác */}
                            {isAuthor(post) && (
                              <button
                            ...
                            {/* Hiển thị nút Delete cho cả admin và author */}
                            <button
