        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map((post) => (
              ...
              >
                {/* Container cho ảnh với tỷ lệ cố định */}
                ...
                {/* Overlay content */}
                <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/40 to-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-between p-4">
                  ...
                  {/* Post Content */}
                  <div className="text-white text-center line-clamp-3 overflow-hidden">
