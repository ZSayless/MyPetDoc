        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map((post) => (
              <div
                key={post.id}
                className="bg-white rounded-lg shadow-sm relative group flex flex-col"
              >
                {/* Container cho ảnh có thể scroll */}
                ...
                {/* Overlay khi hover */}
                <div 
                  className="absolute inset-0 bg-gradient-to-b from-black/60 via-transparent to-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-between p-4 overflow-y-auto max-h-[500px]"
                >
                  {/* Post Header with Edit/Delete */}
                  <div className="flex items-center justify-between sticky top-0 bg-black/30 backdrop-blur-sm p-2 rounded-lg z-10">
                  ...
                  {/* Post Content */}
                  <div className="text-white text-center flex-1 overflow-y-auto py-4">
                    <p className="bg-black/30 p-2 rounded-lg backdrop-blur-sm">
                      {post.description}
                    </p>
                  </div>

                  {/* Post Actions */}
                  <div className="flex items-center justify-center gap-4 text-white mt-2 sticky bottom-0 bg-black/30 backdrop-blur-sm p-2 rounded-lg">
                    <button
