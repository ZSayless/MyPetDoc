      ...
      <div className="bg-white rounded-xl w-full max-w-xl mx-4">
        ...
        <form onSubmit={handleSubmit} className="p-4">
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <button
              type="submit"
              className="px-6 py-2 bg-blue-600 text-white rounded-full hover:bg-[#98E9E9] hover:text-[#1A3C8E] transition-colors disabled:opacity-50"
              disabled={loading || !content.trim()}
            >
              {loading ? t("community.createPost.posting") : t("community.createPost.post")}
            </button>
          </div>
        </form>
      </div>
