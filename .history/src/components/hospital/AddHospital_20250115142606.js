...
function AddHospital() {
  ...
  const getEmbedUrl = (url) => {
    try {
      // Nếu là URL ngắn (dạng maps.app.goo.gl)
      if (url.includes('maps.app.goo.gl')) {
        return `https://www.google.com/maps/embed?pb=${url.split('/').pop()}`;
      }
      
      // Nếu là URL đầy đủ
      if (url.includes('google.com/maps')) {
        // Chuyển URL thành dạng embed
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      name="mapUrl"
                      placeholder='Paste iframe code here... Example: <iframe src="https://www.google.com/maps/embed?..." ...'
                      onChange={(e) => {
                        // Extract src từ iframe code
                        const src = e.target.value.match(/src="([^"]+)"/)?.[1] || '';
                        setMapUrl(src);
                      }}
                      className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                      rows={3}
