          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="grid grid-cols-3 gap-2 md:flex md:gap-4">
              <button
                ...
                className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 px-2 py-1.5 md:px-4 md:py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200"
              >
                <Heart size={20} fill={isFavorite ? "currentColor" : "none"} />
                <span className="text-center text-xs md:text-sm whitespace-nowrap">
                  {isFavorite ? (
                    <>
                      Remove
              ...
              <button
                onClick={handleCall}
                className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 px-2 py-1.5 md:px-4 md:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
              >
              ...
              <button
                ...
                className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 px-2 py-1.5 md:px-4 md:py-2 bg-teal-100 text-teal-700 rounded-lg hover:bg-teal-200"
              >
