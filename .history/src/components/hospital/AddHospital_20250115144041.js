                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      How to get URL:<br/>
                      1. Find your hospital on Google Maps<br/>
                      2. Click Share {'>'} Embed a map<br/>
                      3. From the iframe code, copy ONLY the URL in src="..."<br/>
                      4. The URL should start with "https://www.google.com/maps/embed?pb="
                    </p>
                  </div>
