...
function AddHospital() {
  ...
  // Chuyển đổi URL thông thường thành URL embed
  const handleMapUrlChange = (e) => {
    const url = e.target.value;
    let embedUrl;

    if (url.includes('maps.app.goo.gl')) {
      // Đối với URL ngắn, chuyển thành dạng embed trực tiếp
      embedUrl = `https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=${encodeURIComponent(url)}`;
      ...
      // Nếu là URL khác, thử nhúng trực tiếp
      embedUrl = `https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=${encodeURIComponent(url)}`;
    }
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Just copy and paste the URL from Google Maps
                    </p>
                  </div>
