          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="w-full bg-[#98E9E9] text-gray-700 py-2.5 rounded-lg hover:bg-[#7CD5D5] transition-colors font-medium"
                  disabled={loading}
                >
                  {loading
                    ? t("hospitalRegister.form.uploading")
                    : t("hospitalRegister.form.submit")}
                </button>
              </div>
            </form>
          </div>
