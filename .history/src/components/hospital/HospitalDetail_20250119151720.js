            ...
            <div className="bg-white rounded-lg shadow-sm p-4 md:p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-medium">{t("hospitalDetail.workingHours.title")}</h3>
                    {hospital.workingHours.map((schedule, index) => (
                      <div key={index} className="text-gray-600">
                        <p className="font-medium">
                          {schedule.days === "Monday - Friday" 
                            ? t("hospitalDetail.workingHours.weekdays")
                            : t("hospitalDetail.workingHours.weekends")}
                        </p>
                        <p>{schedule.time}</p>
                      </div>
                    ))}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                {hospital.services?.map((service, index) => (
                  <div key={index} className="flex items-center gap-2">
                    ...
                    <span className="text-sm md:text-base">{t(`hospitalDetail.services.${service.toLowerCase().replace(/\s+/g, '')}`)}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-4 md:mb-6">
            ...
            {canUploadPhotos() && (
              ...
              >
                <Upload size={18} />
                {t("hospitalDetail.gallery.uploadPhoto")}
              </button>
            )}
          </div>
